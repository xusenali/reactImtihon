...
const MobileAccessories = () => {
  ...
  const accessories = data?.filter(item => item.category === 'mobile-accessories');

  return (
    <div className="mt-10 w-[80%] mx-auto">
      <ul className='flex gap-5 items-center'>
        <Link to='/'><li className='cursor-pointer text-gray-400'>Home</li></Link>
        <li><FaAngleRight className='text-gray-400' /></li>
        <li className='cursor-pointer text-gray-400'>Mobile Accessories</li>
      </ul>
